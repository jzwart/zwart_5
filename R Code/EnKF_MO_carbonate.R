...
source('/Users/Jake/Documents/Jake/MyPapers/Zwart 5/R Code/loadMOData.R')
library(MASS)
library(data.table)
library(R.utils)
...
load('/Users/Jake/Documents/Jake/MyPapers/Zwart 5/R Data/MO_20170412.RData')
...
data2$hypo_dicInt<-data2$hypo_dicInt*0.85 # entrained CO2 is much less than where we measure CO2
...
parGuess <- c(0.001,0.1,0.30,0.9,0.1,0.001,0.1) #r20; units: day-1; fraction labile of loaded DOC; fraction inlet that goes into epi; turnover rate parameters set constant frac labile estimated 
